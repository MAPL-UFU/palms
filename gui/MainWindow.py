...
"//rgb(238, 238, 236)")
        ...
        self.serialConection_comboBox = QtWidgets.QComboBox(self.tab_setup)
        self.serialConection_comboBox.setMaximumSize(QtCore.QSize(400, 16777215))
        self.serialConection_comboBox.setObjectName("serialConection_comboBox")
        self.verticalLayout_9.addWidget(self.serialConection_comboBox)
        self.addSerial_pushButton = QtWidgets.QPushButton(self.tab_setup)
        self.addSerial_pushButton.setMinimumSize(QtCore.QSize(0, 40))
        self.addSerial_pushButton.setMaximumSize(QtCore.QSize(400, 16777215))
        self.addSerial_pushButton.setObjectName("addSerial_pushButton")
        self.verticalLayout_9.addWidget(self.addSerial_pushButton)
        ...
        self.groupBox_Labels.setGeometry(QtCore.QRect(10, 210, 250, 150))
        ...
        self.confirmSerialConection_pushButton.setGeometry(QtCore.QRect(10, 370, 251, 50))
        self.confirmSerialConection_pushButton.setMinimumSize(QtCore.QSize(0, 50))
        self.confirmSerialConection_pushButton.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.confirmSerialConection_pushButton.setObjectName("confirmSerialConection_pushButton")
        self.serialConection_lineEdit = QtWidgets.QLineEdit(self.tab_petrinet)
        self.serialConection_lineEdit.setGeometry(QtCore.QRect(10, 160, 251, 30))
        self.serialConection_lineEdit.setMinimumSize(QtCore.QSize(0, 30))
        self.serialConection_lineEdit.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.widget = QtWidgets.QWidget(self.tab_petrinet)
        self.widget.setGeometry(QtCore.QRect(430, 390, 151, 41))
        ...
        self.stopConnection_pushButton = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Serial COM"))
        self.addSerial_pushButton.setText(_translate("MainWindow", "Add"))
        ...
        self.confirmSerialConection_pushButton.setText(_translate("MainWindow", "SAVE SETUP"))
